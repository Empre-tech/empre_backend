        ...
        "/api/entities/{id}/images": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Image Type (profile, banner, gallery)",
                        "name": "type",
                        "in": "formData",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "handlers.CreateEntityRequest": {
            ...
            "properties": {
                ...
                "gallery": {
                    "description": "List of Media IDs (UUIDs)",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "models.Message": {
            ...
            "properties": {
                ...
                "sender_id": {
                    "description": "User who typed the message",
                    "type": "string"
                },
                "sent_by_entity": {
